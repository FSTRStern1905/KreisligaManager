...
def main() -> None:
    ...
    try:
        ...
        print(
            f"Tore ≠ Goal-Events technisch: "
            f"{len(event_goal_mismatches)}"
        )
        print(
            f"Tore ≠ Goal-Events Quelle:    "
            f"{len(source_goal_mismatches)}"
        )
        print(
        ...
        print("=" * 110)
        print(
            "QUELLSEITIGE TOR/EVENT-ABWEICHUNGEN"
        )
        print("=" * 110)

        if not source_goal_mismatches:
            print("(keine)")
        else:
            for (
                match,
                ...
                print(
                    "  Grund: FUSSBALL.DE-Endergebnis 6:0, "
                    "Liveticker-Rohdaten enden bei 5:0."
                )
        ...
        print(
            f"TOR-EVENTS TECHNISCH: "
            f"{'OK' if not event_goal_mismatches else 'PRÜFEN'}"
        )
        print(
            f"QUELLSEITIGE TORABWEICHUNGEN: "
            f"{len(source_goal_mismatches)}"
        )

        print()
        print(
            "Hinweis: Fehlende Events, Zuschauer oder "
            "quellseitige Torabweichungen werden separat "
            "bewertet und gelten nicht als Importfehler."
        )
