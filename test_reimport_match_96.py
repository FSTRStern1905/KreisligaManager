...
TEST_DB = Path("data/database/match_96_reimport_test.db")
...
def main() -> None:
    print("=" * 94)
    print("SPIEL 96 REIMPORT-TEST / PHILIPP STEIGER")
    print("=" * 94)
    ...
    try:
        ...
        if valid_target and valid_starters:
            connection.commit()
            print(
                "ERGEBNIS: SPIEL 96 REIMPORT SAUBER."
            )
            print(
            ...
            connection.rollback()
            print(
                "ERGEBNIS: SPIEL 96 NOCH NICHT SAUBER."
            )
            print(
