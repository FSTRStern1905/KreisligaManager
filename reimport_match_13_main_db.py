...
def main() -> None:
    print("=" * 94)
    print("HAUPT-DB REIMPORT: SPIEL 13")
    print("=" * 94)
    ...
    backup_path = BACKUP_DIR / (
        "kreisligamanager_before_match_13_"
        f"{timestamp}.db"
    )
    ...
    print("Es wird ausschließlich Spiel 13 reimportiert.")
    ...
    try:
        ...
        if valid_target and valid_starters:
            connection.commit()
            print(
                "ERGEBNIS: SPIEL 13 REIMPORT ERFOLGREICH."
            )
            print(
            ...
            connection.rollback()
            print(
                "ERGEBNIS: SPIEL 13 REIMPORT FEHLGESCHLAGEN."
            )
            print(
