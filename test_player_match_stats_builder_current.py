...
def main() -> None:
    print("=" * 100)
    print(
        "CURRENT FULL-PIPELINE TEST: "
        "PLAYER_MATCH_STATS BUILDER"
    )
    print("=" * 100)
    ...
    try:
        ...
        if (
            ...
            print()
            print(
                "ERGEBNIS: CURRENT FULL-PIPELINE "
                "SPIELERLOGIK SAUBER."
            )
            print(
                "Team-Minuten-Abweichungen werden "
                "mit dem zweiten Test klassifiziert."
            )
            print("=" * 100)
            return
