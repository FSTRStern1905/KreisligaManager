...
class CompetitionAwayTableTab(QWidget):
    def __init__(self):
        super().__init__()
    ...
    def setup_ui(self):
        ...
        title = QLabel("✈️ Auswärtstabelle")
    ...
    def load_data(self):
        ...
        try:
            ...
            QMessageBox.critical(
                ...
                "Datenbankfehler",
                (
                    "Die Auswärtstabelle konnte nicht "
                    f"geladen werden:\n{error}"
                ),
            )
