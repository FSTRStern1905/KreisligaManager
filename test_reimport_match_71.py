...
TEST_DB = Path("data/database/match_71_reimport_test.db")
...
def main() -> None:
    print("=" * 94)
    print("SPIEL 71 REIMPORT-TEST / LEVIN STEFFES")
    print("=" * 94)
    ...
    try:
        ...
        if valid_target and valid_starters:
            connection.commit()
            print(
                "ERGEBNIS: SPIEL 71 REIMPORT SAUBER."
            )
            print(
            ...
            connection.rollback()
            print(
                "ERGEBNIS: SPIEL 71 NOCH NICHT SAUBER."
            )
            print(
