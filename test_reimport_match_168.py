...
TEST_DB = Path("data/database/match_168_reimport_test.db")
...
def main() -> None:
    print("=" * 94)
    print("SPIEL 168 REIMPORT-TEST / 8 EINSEITIGE AUSWECHSLUNGEN")
    print("=" * 94)
    ...
    try:
        ...
        if valid_events and valid_starters:
            connection.commit()
            print(
                "ERGEBNIS: SPIEL 168 REIMPORT SAUBER."
            )
            print(
            ...
            connection.rollback()
            print(
                "ERGEBNIS: SPIEL 168 NOCH NICHT SAUBER."
            )
            print(
