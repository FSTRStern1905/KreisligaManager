...
def classify_case(
    ...
    if dismissals and team_minutes < EXPECTED_TEAM_MINUTES:
        return (
            "C",
            (
    ...
    return (
        "B",
        "Alle Wechselminuten vorhanden, Abweichung bleibt technisch zu prüfen.",
    )
...
def main() -> None:
    ...
    try:
        ...
        print("=" * 100)
        print(
            "CURRENT KREISLIGA A7: "
            "SAMMELDIAGNOSE TEAM-MINUTEN != 990"
        )
        print("=" * 100)
        ...
        if not groups["B"]:
            ...
            print(
                ...
                "technischen Rechenabweichungen."
            )
        else:
            print()
            print(
                "STATUS: PRÜFEN - echte "
                "technische Rechenabweichungen "
                "vorhanden."
            )
