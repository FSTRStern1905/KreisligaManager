...
def main() -> None:
    ...
    backup_db = BACKUP_DIR / (
        f"kreisligamanager_before_match_260_{timestamp}.db"
    )
    ...
    print("Es wird ausschließlich Spiel 260 reimportiert.")
    ...
    try:
        ...
        if valid:
            connection.commit()
            print(
                "ERGEBNIS: SPIEL 260 REIMPORT ERFOLGREICH."
            )
            print(
            ...
            connection.rollback()
            print(
                "ERGEBNIS: SPIEL 260 REIMPORT FEHLGESCHLAGEN."
            )
            print(
