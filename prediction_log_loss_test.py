...
def main() -> None:
    ...
    try:
        ...
        print("=" * 125)
        print("PREDICTION ENGINE – BRIER / LOG LOSS / 1X2 VERGLEICH")
        print("=" * 125)
        ...
        for opponent_weight in OPPONENT_WEIGHTS:
            print("=" * 125)
            print(f"OPPONENT STRENGTH WEIGHT: {opponent_weight:.2f}")
            print("=" * 125)
            ...
            for competition in competitions:
                ...
                print(
                    ...
                    f"{summary.correct_outcomes:>3}/{summary.matches_tested:<3} | "
            ...
            average_brier = total_brier / total_matches
            average_log_loss = total_log_loss / total_matches
...
def _find_competitions(
    ...
    cursor.execute(
        ...
        ORDER BY
            ...
            competitions.competition_id
        """,
        (MIN_FINISHED_MATCHES, MIN_MATCHDAYS),
    )
