...
def main() -> None:
    print("=" * 94)
    print("HAUPT-DB REIMPORT: SPIEL 131")
    print("=" * 94)
    ...
    backup_path = BACKUP_DIR / (
        "kreisligamanager_before_match_131_"
        f"{timestamp}.db"
    )
    ...
    print("Es wird ausschließlich Spiel 131 reimportiert.")
    ...
    try:
        ...
        if valid_events and valid_starters:
            connection.commit()
            print(
                "ERGEBNIS: SPIEL 131 REIMPORT ERFOLGREICH."
            )
            print(
            ...
            connection.rollback()
            print(
                "ERGEBNIS: SPIEL 131 REIMPORT FEHLGESCHLAGEN."
            )
            print(
